...
@NonNls
public class RandomConstructorParametersIntention extends PsiElementBaseIntentionAction implements IntentionAction {

  @NotNull
  public String getText() {
    return "Generate random constructor";
  }
  ...
  public String getFamilyName() {
    return "RandomParametersConstructorIntention";
  }
   ...
   *   @see RandomConstructorParametersIntention#startInWriteAction()
   */
  public void invoke(@NotNull Project project, Editor editor, @NotNull PsiElement element) throws IncorrectOperationException {
    int a = project != null ? 2: 1;
